    ...
    public static List<DecoderCatalogEntry> entries() {
        return List.of(
                ...
                new DecoderCatalogEntry("p25-phase2", "P25 Phase 2",
                        ...
                        DecoderCatalogEntry.Availability.REQUIRES_PACKAGE),
                new DecoderCatalogEntry("jmbe", "JMBE Voice Library 1.0.9",
                        "Optional IMBE/AMBE voice conversion for P25 Phase 1/2, DMR, and compatible formats.",
                        "GPL-3.0 with upstream patent notice", URI.create("https://github.com/DSheirer/jmbe/releases/latest"),
                        Set.of(DecoderCapability.P25_PHASE_1, DecoderCapability.P25_PHASE_2, DecoderCapability.DMR),
                        DecoderCatalogEntry.Availability.READY_TO_INSTALL),
